...
from icd11_search.src.data_loader import load_and_preprocess_data, get_text_data
...
def generate_and_save_embeddings():
    ...
    embeddings_path = os.path.join(embeddings_dir, 'icd11_embeddings.npy')
...
if __name__ == '__main__':
    ...
    print("Starting ICD-11 embedding generation process...")
